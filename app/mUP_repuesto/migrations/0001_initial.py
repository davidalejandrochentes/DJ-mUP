    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maquina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mUP_repuesto.maquina')),
            ],
        ),
        migrations.CreateModel(
            name='Inventario',
            fields=[
                ...
                ('parte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mUP_repuesto.parte')),
            ],
        ),
    ]
